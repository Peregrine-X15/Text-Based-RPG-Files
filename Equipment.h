...
struct StatModifier
{
	...
	enum class ElementalType {FIRE=0, RADS, ICE, ELECTRIC, NO_TYPE};
...
{
	//stopped video at 11:21, video 7-1 items equipment inventory
	enum class WeaponType {RIFLE=0, SWORD, PISTOL, KNIFE, CANNON, SHOTGUN, ROCKET_LAUNCHER, SMG, NOT_A_WEAPON };
	int attackPwr;
...
class Weapon : public Equipment //inheriting Equipment
{
public: 
	Weapon();
...
public:
	Armor();
	Armor(const std::wstring& name, const std::wstring& description, int buy_price, int sell_price,
